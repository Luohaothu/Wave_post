    ...
    !Parameters:            Meanimg:
    !RE                     Reynolds Number
    !ARF                    Steamwise wave number
    !BAT                    Sidewise wave number
    !DT                     Time step
    !MX                     Mesh size in X direction
    !MY                     Mesh size in Y direction
    !MZ                     Mesh size in Z direction
    !FR0
    !TIME0                  Initial time
    !ITB                    Begin time iter
    !ITE                    End time iter
    !ITSTEP                 Time iter step
    !IFC
    !IFF
    !IFG
    !DP0
    ...
    !NDX,NDY,NDZ are defined in dims.FI
    ...
    !NDX2, NDZ2 are defined in dims.FI
    !------ form coordinates ------C
    !
    DO J=0,NDY
        Y(J)=COS(J*PAI/MY)
    ...
    !Four pieces of repetitive code
    !=====================================================
    DO IT=ITB,ITE,ITSTEP
        ...
        READ(15)ETAU    !Eta-U  :   Deformation of upper wall
        READ(15)ETAD    !Eta-D  :   Deformation of lower wall
        CLOSE(15)
